...
// // Forex pairs data
// const forexPairs = [
//   { value: "EURUSD", label: "EUR/USD", pipLocation: 4 },
//   { value: "USDJPY", label: "USD/JPY", pipLocation: 2 },
//   { value: "GBPUSD", label: "GBP/USD", pipLocation: 4 },
//   { value: "USDCHF", label: "USD/CHF", pipLocation: 4 },
//   { value: "AUDUSD", label: "AUD/USD", pipLocation: 4 },
//   { value: "USDCAD", label: "USD/CAD", pipLocation: 4 },
//   { value: "NZDUSD", label: "NZD/USD", pipLocation: 4 },
//   { value: "EURGBP", label: "EUR/GBP", pipLocation: 4 },
//   { value: "EURJPY", label: "EUR/JPY", pipLocation: 2 },
//   { value: "GBPJPY", label: "GBP/JPY", pipLocation: 2 },
// ];

// // Fetch exchange rate
// async function getExchangeRate() {
//   const cachedRate = localStorage.getItem('usdNgnRate');
//   const cachedTime = localStorage.getItem('rateTimestamp');
//   const now = Date.now();
//   if (cachedRate && cachedTime && now - cachedTime < 3600000) {
//     return parseFloat(cachedRate);
//   }
//   try {
//     const response = await axios.get('https://v6.exchangerate-api.com/v6/23eaa1d5650316be05fe1720/latest/USD');
//     if (response.data.result !== 'success') {
//       throw new Error(response.data['error-type'] || 'API error');
//     }
//     const rate = response.data.conversion_rates.NGN;
//     localStorage.setItem('usdNgnRate', rate);
//     localStorage.setItem('rateTimestamp', now);
//     return rate;
//   } catch (error) {
//     console.error('Error fetching exchange rate:', error);
//     document.getElementById('error').textContent = 'Failed to fetch exchange rate. Using fallback rate (1650 NGN/USD).';
...
//   const pipSize = pipLocation === 4 ? 0.0001 : 0.01;
...
//   const usdNgnRate = await getExchangeRate();
//   let pipValuePerStandardLot;
//   if (pair.endsWith("USD")) {
//     pipValuePerStandardLot = 10;
//   } else if (pair.startsWith("USD")) {
//     pipValuePerStandardLot = 10 / entryPrice;
//   } else {
//     pipValuePerStandardLot = 10 / 1.2;
//   }
...
//   document.getElementById("results").classList.add("results-highlight");
//   setTimeout(() => document.getElementById("results").classList.remove("results-highlight"), 1000);
